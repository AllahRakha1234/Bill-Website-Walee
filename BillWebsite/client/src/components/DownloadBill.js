  ...
  return (
    <div className="mainBox container mx-auto">
      ...
      <div className="middleBillBox flex flex-row -mt-1">
        <div className="middleLefttBill ml-9 w-32 h-5 border-[#A493AD] pl-12 font-semibold text-[#A493AD] text-[10px] border-l-2">
      ...
      <div className="lowestBillBox flex flex-row">
        ...
        <div className="lowestMiddle-2-Bill mt-3 -ml-[138px] w-[138px] h-7 border-r-2 border-[#A493AD]  text-[#A493AD] text-[12px] pl-14">
